...
class SetGlobalPrivacySettings:
    async def set_global_privacy_settings(
        ...
        if display_gifts_button is not None:
            settings.show_gift_button = display_gifts_button

        if allowed_gifts is not None:
            settings.disallowed_gifts = allowed_gifts.write()
